...
- `CLAUDE.md` - a **thin constitution / bootstrap** that auto-loads every message, points at PROJECT.md, and carries the `<!-- e2e-state: -->` resume marker.
